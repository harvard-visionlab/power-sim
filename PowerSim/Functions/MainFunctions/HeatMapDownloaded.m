function [hImage, hText, hXText] = HeatMapDownloaded(mat, xlab, ylab, textmat, varargin)
...
if round(param.MinColorValue,2) == round(param.MaxColorValue,2)
    param.MinColorValue = 0;
    param.MaxColorValue = 1;
end
